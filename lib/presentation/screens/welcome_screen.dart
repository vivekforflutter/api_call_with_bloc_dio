        ...
        body: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text("Bring together your files,your tools, projects and people.Including a new mobile and desktop application",style:
                TextStyle(fontSize: 15,color: Color(0xFF666670) , height: 1.3, fontWeight: FontWeight.w300),
